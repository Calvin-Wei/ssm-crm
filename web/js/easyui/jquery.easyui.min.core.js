...
(function ($) {
    ...
    $.fn.draggable.defaults = {
        ...
        edge: 0,
        axis: null,
        onBeforeDrag: function (e) {}, onStartDrag: function (e) {}, onDrag: function (e) {}, onStopDrag: function (e) {}
    };
    $.fn.draggable.isDragging = false;
})(jQuery);
(function ($) {
    ...
    $.fn.droppable.defaults = {
        accept: null,
        disabled: false,
        onDragEnter: function (e, _67) {}, onDragOver: function (e, _68) {}, onDragLeave: function (e, _69) {}, onDrop: function (e, _6a) {}
    };
})(jQuery);
(function ($) {
    ...
    $.fn.resizable.defaults = {
        ...
        maxHeight: 10000,
        edge: 5,
        onStartResize: function (e) {}, onResize: function (e) {}, onStopResize: function (e) {}
    };
    $.fn.resizable.isResizing = false;
})(jQuery);
(function ($) {
...
(function ($) {
    ...
    $.fn.pagination.defaults = {
        ...
        onSelectPage: function (_c4, _c5) {}, onBeforeRefresh: function (_c6, _c7) {}, onRefresh: function (_c8, _c9) {}, onChangePageSize: function (_ca) {}, beforePageText: "Page",
                ...
                for (var i = 0; i < _1b8.length; i++) {
					...
					*/
                    ...
                    if (item.state == "closed") {
                        cc.push("<span class=\"tree-hit tree-collapsed\">" + opts.formatter.call(_1b4, item) + "</span>");
                        //cc.push("<span class=\"tree-icon tree-folder "+(item.iconCls?item.iconCls:"")+"\"></span>");
                    } else {
                        if (item.children && item.children.length) {
                            cc.push("<span class=\"tree-hit tree-expanded\">" + opts.formatter.call(_1b4, item) + "</span>");
                    ...
                    if (item.children && item.children.length) {
                        ...
                        //cc.push("<ul style=\"background-color:red;display:" + (item.state == "closed" ? "none" : "block") + "\">");
                        cc.push("<ul style=\"display:none\">");
                        cc = cc.concat(tmp);
                        cc.push("</ul>");
                    }
                    cc.push("</li>");
...
(function ($) {
    ...
    $.fn.tooltip.defaults = {
        ...
        showDelay: 200,
        hideDelay: 100,
        onShow: function (e) {}, onHide: function (e) {}, onUpdate: function (_1fb) {}, onPosition: function (left, top) {}, onDestroy: function () {}
    };
})(jQuery);
(function ($) {
    $.fn._remove = function () {
    ...
    $.fn.panel.defaults = {
        ...
        }, onBeforeLoad: function (_256) {}, onLoad: function () {}, onLoadError: function () {}, onBeforeOpen: function () {}, onOpen: function () {}, onBeforeClose: function () {}, onClose: function () {}, onBeforeDestroy: function () {}, onDestroy: function () {}, onResize: function (_257, _258) {}, onMove: function (left, top) {}, onMaximize: function () {}, onRestore: function () {}, onMinimize: function () {}, onBeforeCollapse: function () {}, onBeforeExpand: function () {}, onCollapse: function () {}, onExpand: function () {}
    };
})(jQuery);
(function ($) {
...
(function ($) {
    ...
    $.fn.accordion.defaults = {
        ...
        multiple: false,
        selected: 0,
        onSelect: function (_2f1, _2f2) {}, onUnselect: function (_2f3, _2f4) {}, onAdd: function (_2f5, _2f6) {}, onBeforeRemove: function (_2f7, _2f8) {}, onRemove: function (_2f9, _2fa) {}
    };
})(jQuery);
(function ($) {
    function _2fb(_2fc) {
    ...
    $.fn.tabs.defaults = {
        ...
        scrollIncrement: 100,
        scrollDuration: 400,
        onLoad: function (_367) {}, onSelect: function (_368, _369) {}, onUnselect: function (_36a, _36b) {}, onBeforeClose: function (_36c, _36d) {}, onClose: function (_36e, _36f) {}, onAdd: function (_370, _371) {}, onUpdate: function (_372, _373) {}, onContextMenu: function (e, _374, _375) {}
    };
})(jQuery);
(function ($) {
    var _376 = false;
...
(function ($) {
    ...
    $.fn.menu.defaults = {
        ...
        duration: 100,
        hideOnUnhover: true,
        onShow: function () {}, onHide: function () {}, onClick: function (item) {}
    };
})(jQuery);
(function ($) {
    function init(_400) {
...
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        ...
        onBeforeValidate: function () {}, onValidate: function (_453) {}
    };
})(jQuery);
(function ($) {
    function init(_454) {
    ...
    $.fn.textbox.defaults = $.extend({}, $.fn.validatebox.defaults, {
        ...
        onChange: function (_48d, _48e) {}, onResize: function (_48f, _490) {}, onClickButton: function () {}, onClickIcon: function (_491) {}
    });
})(jQuery);
(function ($) {
    function _492(_493) {
...
(function ($) {
    ...
    $.fn.form.defaults = {
        ...
        }, success: function (data) {}, onBeforeLoad: function (_4da) {}, onLoadSuccess: function (data) {}, onLoadError: function () {}
    };
})(jQuery);
(function ($) {
    function _4db(_4dc) {
...
(function ($) {
    ...
    $.fn.calendar.defaults = {
        ...
        formatter: function (date) {
            ...
            return true;
        }, onSelect: function (date) {}, onChange: function (_51b, _51c) {}
    };
})(jQuery);
(function ($) {
    function _51d(_51e) {
    ...
    $.fn.spinner.defaults = $.extend({}, $.fn.textbox.defaults, {
        ...
        max: null,
        increment: 1,
        spin: function (down) {}, onSpinUp: function () {}, onSpinDown: function () {}
    });
})(jQuery);
(function ($) {
    function _529(_52a) {
...
(function ($) {
    ...
    var _711 = {
        ...
        }, onBeforeRender: function (_749, rows) {}, onAfterRender: function (_74a) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        showFooter: false,
        scrollbarSize: 18,
        rowStyler: function (_74c, _74d) {}, loader: function (_74e, _74f, _750) {
            var opts = $(this).datagrid("options");
            if (!opts.url) {
                return false;
            }
    ...
    function _7b7(_7b8) {
        ...
        $(_7b8).datagrid($.extend({}, opts, {
            ...
            loader: function () {
                ...
                return false;
            }, onLoadSuccess: function () {}, onResizeColumn: function (_7ba, _7bb) {
                _7d1(_7b8);
            ...
            function _850(_851, _852, _853) {
                ...
                for (var i = 0; i < _853.length; i++) {
                    ...
                    if (row.children && row.children.length) {
                        ...
                        _856.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan=" 
                        		+ (_84d.length + (opts.rownumbers ? 1 : 0)) 
                        		+ "><div class=\"div-tree-"+row.id+"\" style=\"display:" + v + "\">");
                        _856 = _856.concat(tt);
                        _856.push("</div></td></tr>");
                    }
                }
                    ...
                    if (col.checkbox) {
                        ...
                        if (_864 == opts.treeField) {
							...
							for(var j=0;j<_863;j++){
								cc.push("<span class=\"tree-indent2\"></span>");
							}
                            ...
                            if (row.state == "closed") {
                                ...
                                if (row.children && row.children.length) {
                                    ...
                                    cc.push("<span id=\"treegrid-span-tree-"+row.id+"\" class=\"tree-icon tree-folder icon-top\"></span>");
                                } else {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        loader: function (_886, _887, _888) {
	       ...
	       onClickRow: function(row) {
	          /* treegrid 折叠 展开 */
	          if (row.children && row.children.length) {
	        	  var div_tree = $(".div-tree-"+row.id);
	        	  var treegrid_span_tree = $("#treegrid-span-tree-"+row.id);
	        	  if(div_tree.css("display") == "block"){
	        		  div_tree.css("display", "none");
	        		  treegrid_span_tree.removeClass("icon-top"); 
	        		  treegrid_span_tree.addClass("icon-bottom"); 
	              } else {
	            	  div_tree.css("display", "block");
	            	  treegrid_span_tree.removeClass("icon-bottom"); 
	        		  treegrid_span_tree.addClass("icon-top"); 
	              }
               }
	       },
...
(function ($) {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        ...
        delay: 200,
        keyHandler: {
            up: function (e) {}, down: function (e) {}, left: function (e) {}, right: function (e) {}, enter: function (e) {}, query: function (q, e) {}
        },
        onShowPanel: function () {}, onHidePanel: function () {}, onChange: function (_8d6, _8d7) {}
    });
})(jQuery);
(function ($) {
    var _8d8 = 0;
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        keyHandler: {
            up: function (e) {
                ...
                nav(this, "next");
                e.preventDefault();
            }, left: function (e) {}, right: function (e) {}, enter: function (e) {
                _902(this);
            }, query: function (q, e) {
                _8fd(this, q);
            }
        ...
        }, onBeforeLoad: function (_923) {}, onLoadSuccess: function () {}, onLoadError: function () {}, onSelect: function (_924) {}, onUnselect: function (_925) {}
    });
})(jQuery);
(function ($) {
    function _926(_927) {
...
(function ($) {
    ...
    $.fn.datebox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        sharedCalendar: null,
        keyHandler: {
            up: function (e) {}, down: function (e) {}, left: function (e) {}, right: function (e) {}, enter: function (e) {
                _975(this);
            }, query: function (q, e) {
                _972(this, q);
            }
...
(function ($) {
    ...
    $.fn.slider.defaults = {
        ...
        }, onChange: function (_9e2, _9e3) {}, onSlideStart: function (_9e4) {}, onSlideEnd: function (_9e5) {}, onComplete: function (_9e6) {}
    };
})(jQuery);