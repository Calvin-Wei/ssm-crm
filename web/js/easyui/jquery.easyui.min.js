...
(function($) {
    ...
    $.fn.draggable = function(_4c, _4d) {
        ...
        return this.each(function() {
            ...
            if (_4f) {
                ...
                _4e = $.extend({},
                $.fn.draggable.defaults, $.fn.draggable.parseOptions(this), _4c || {});
            }
    ...
    $.fn.draggable.parseOptions = function(_5c) {
        var t = $(_5c);
        return $.extend({},
        $.parser.parseOptions(_5c, ["cursor", "handle", "axis", {
            "revert": "boolean",
            "deltaX": "number",
            "deltaY": "number",
            "edge": "number"
    ...
    $.fn.droppable = function(_63, _64) {
        ...
        return this.each(function() {
            ...
            if (_65) {
                ...
                $.data(this, "droppable", {
                    options: $.extend({},
                    $.fn.droppable.defaults, $.fn.droppable.parseOptions(this), _63)
                });
            }
        });
    };
    ...
    $.fn.droppable.parseOptions = function(_66) {
        var t = $(_66);
        return $.extend({},
        $.parser.parseOptions(_66, ["accept"]), {
            disabled: (t.attr("disabled") ? true: undefined)
        });
    };
    ...
    function _12b(_12c, ul, _12d, _12e) {
        ...
        var _131 = opts.loader.call(_12c, _12d,
        function(data) {
    ...
    $.fn.tree = function(_191, _192) {
        ...
        return this.each(function() {
            ...
            if (_193) {
                ...
                opts = $.extend({},
                $.fn.tree.defaults, $.fn.tree.parseOptions(this), _191);
                $.data(this, "tree", {
                    options: opts,
                    tree: _d2(this),
                    data: []
    ...
    $.fn.tree.parseOptions = function(_1ae) {
        var t = $(_1ae);
        return $.extend({},
        $.parser.parseOptions(_1ae, ["url", "method", {
            checkbox: "boolean",
        ...
        return this.each(function() {
            ...
            if (_1d5) {
                ...
                _1d5 = $.data(this, "progressbar", {
                    options: $.extend({},
                    $.fn.progressbar.defaults, $.fn.progressbar.parseOptions(this), _1d2),
                    bar: init(this)
                });
            }
    ...
    $.fn.progressbar.parseOptions = function(_1d9) {
        return $.extend({},
        $.parser.parseOptions(_1d9, ["width", "height", "text", {
            value: "number"
        }]));
    };
    ...
    $.fn.tooltip = function(_1f6, _1f7) {
        ...
        return this.each(function() {
            ...
            if (_1f8) {
                ...
                $.data(this, "tooltip", {
                    options: $.extend({},
                    $.fn.tooltip.defaults, $.fn.tooltip.parseOptions(this), _1f6)
                });
                init(this);
            }
            _1dd(this);
    ...
    $.fn.tooltip.parseOptions = function(_1fa) {
        var t = $(_1fa);
        var opts = $.extend({},
        $.parser.parseOptions(_1fa, ["position", "showEvent", "hideEvent", "content", {
            trackMouse: "boolean",
            deltaX: "number",
            deltaY: "number",
            showDelay: "number",
        ...
        return this.each(function() {
            ...
            if (_274) {
                ...
                _274 = $.data(this, "window", {
                    options: $.extend({},
                    $.fn.window.defaults, $.fn.window.parseOptions(this), _271)
                });
    ...
    $.fn.window.parseOptions = function(_278) {
        return $.extend({},
        $.fn.panel.parseOptions(_278), $.parser.parseOptions(_278, [{
            draggable: "boolean",
            resizable: "boolean",
            shadow: "boolean",
            modal: "boolean",
    ...
    $.fn.dialog = function(_283, _284) {
        ...
        return this.each(function() {
            ...
            if (_286) {
                ...
                $.data(this, "dialog", {
                    options: $.extend({},
                    $.fn.dialog.defaults, $.fn.dialog.parseOptions(this), _283)
                });
            }
            _279(this);
        });
    ...
    $.fn.dialog.parseOptions = function(_289) {
        return $.extend({},
        $.fn.window.parseOptions(_289), $.parser.parseOptions(_289, ["toolbar", "buttons"]));
    };
    ...
    $.fn.accordion = function(_2e6, _2e7) {
        ...
        return this.each(function() {
            ...
            if (_2e8) {
                ...
                $.data(this, "accordion", {
                    options: $.extend({},
                    $.fn.accordion.defaults, $.fn.accordion.parseOptions(this), _2e6),
    ...
    $.fn.accordion.parseOptions = function(_2f0) {
        var t = $(_2f0);
        return $.extend({},
        $.parser.parseOptions(_2f0, ["width", "height", {
            fit: "boolean",
            border: "boolean",
            animate: "boolean",
            multiple: "boolean",
    ...
    function _318(_319) {
        ...
        $(_319).children("div.tabs-header").unbind().bind("click",
        function(e) {
    ...
    $.fn.tabs = function(_357, _358) {
        ...
        return this.each(function() {
            ...
            if (_359) {
                ...
                $.data(this, "tabs", {
                    options: $.extend({},
                    $.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _357),
                    tabs: [],
                    selectHis: []
                });
                _315(this);
    ...
    $.fn.tabs.parseOptions = function(_366) {
        return $.extend({},
        $.parser.parseOptions(_366, ["tools", "toolPosition", "tabPosition", {
            fit: "boolean",
            border: "boolean",
            plain: "boolean",
            headerWidth: "number",
    ...
    function _396(_397, _398, _399) {
        ...
        if (!_39a[_39c]) {
            _39a[_39c] = _39d(_398);
            _39a[_39c].panel("panel").bind("click",
            function() {
                p.panel("expand", false).panel("open");
                var _39e = _39f();
                p.panel("resize", _39e.collapse);
                p.panel("panel").animate(_39e.expand,
                function() {
        ...
        p.panel("panel").animate(_3a0.collapse, _399,
        function() {
    ...
    function _3a6(_3a7, _3a8) {
        ...
        if (_3a9[_3ab]) {
            ...
            p.panel("panel").animate(_3ac.expand,
            function() {
                _377(_3a7);
            });
        }
    ...
    $.fn.layout = function(_3b2, _3b3) {
        ...
        return this.each(function() {
            ...
            if (_3b4) {
                ...
                var opts = $.extend({},
                $.fn.layout.defaults, $.fn.layout.parseOptions(this), _3b2);
                $.data(this, "layout", {
                    options: opts,
                    panels: {
                        center: $(),
    ...
    $.fn.layout.parsePanelOptions = function(_3bc) {
        var t = $(_3bc);
        return $.extend({},
        $.fn.panel.parseOptions(_3bc), $.parser.parseOptions(_3bc, ["region", {
            split: "boolean",
    ...
    $.fn.menu = function(_3f2, _3f3) {
        ...
        return this.each(function() {
            ...
            if (_3f4) {
                ...
                _3f4 = $.data(this, "menu", {
                    options: $.extend({},
                    $.fn.menu.defaults, $.fn.menu.parseOptions(this), _3f2)
                });
                init(this);
            }
            $(this).css({
        ...
        return this.each(function() {
            ...
            if (_410) {
                ...
                $.data(this, "menubutton", {
                    options: $.extend({},
                    $.fn.menubutton.defaults, $.fn.menubutton.parseOptions(this), _40d)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
    ...
    $.fn.menubutton.parseOptions = function(_412) {
        var t = $(_412);
        return $.extend({},
        $.fn.linkbutton.parseOptions(_412), $.parser.parseOptions(_412, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
        ...
        return this.each(function() {
            ...
            if (_417) {
                ...
                $.data(this, "splitbutton", {
                    options: $.extend({},
                    $.fn.splitbutton.defaults, $.fn.splitbutton.parseOptions(this), _414)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
    ...
    $.fn.splitbutton.parseOptions = function(_41a) {
        var t = $(_41a);
        return $.extend({},
        $.fn.linkbutton.parseOptions(_41a), $.parser.parseOptions(_41a, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
    ...
    function _492(_493) {
        ...
        $(_493).addClass("filebox-f").textbox($.extend({},
        opts, {
            onClickButton: function() {
    ...
    $.fn.filebox = function(_495, _496) {
        ...
        return this.each(function() {
            ...
            if (_498) {
                ...
                $.data(this, "filebox", {
                    options: $.extend({},
                    $.fn.filebox.defaults, $.fn.filebox.parseOptions(this), _495)
                });
            }
            _492(this);
        });
    ...
    function _49a(_49b) {
        ...
        _49e();
        var _49f = _4a0();
        $(_49b).addClass("searchbox-f").textbox($.extend({},
        opts, {
            icons: _49d,
    ...
    $.fn.searchbox = function(_4a5, _4a6) {
        ...
        return this.each(function() {
            ...
            if (_4a8) {
                ...
                $.data(this, "searchbox", {
                    options: $.extend({},
                    $.fn.searchbox.defaults, $.fn.searchbox.parseOptions(this), _4a5)
                });
            }
            _49a(this);
        });
    ...
    $.fn.searchbox.parseOptions = function(_4a9) {
        var t = $(_4a9);
        return $.extend({},
        $.fn.textbox.parseOptions(_4a9), $.parser.parseOptions(_4a9, ["menu"]), {
        ...
        return this.each(function() {
            ...
            if (_4e7) {
                ...
                _4e7 = $.data(this, "numberbox", {
                    options: $.extend({},
                    $.fn.numberbox.defaults, $.fn.numberbox.parseOptions(this), _4e4)
                });
            }
            _4db(this);
        });
    ...
    $.fn.numberbox.parseOptions = function(_4e9) {
        var t = $(_4e9);
        return $.extend({},
        $.fn.textbox.parseOptions(_4e9), $.parser.parseOptions(_4e9, ["decimalSeparator", "groupSeparator", "suffix", {
            min: "number",
            max: "number",
            precision: "number"
        }]), {
        ...
        return this.each(function() {
            ...
            if (_517) {
                ...
                _517 = $.data(this, "calendar", {
                    options: $.extend({},
                    $.fn.calendar.defaults, $.fn.calendar.parseOptions(this), _515)
                });
                init(this);
            }
        ...
        return this.each(function() {
            ...
            if (_530) {
                ...
                $.data(this, "numberspinner", {
                    options: $.extend({},
                    $.fn.numberspinner.defaults, $.fn.numberspinner.parseOptions(this), _52d)
                });
            }
            _529(this);
        });
    ...
    $.fn.numberspinner.parseOptions = function(_531) {
        return $.extend({},
        $.fn.spinner.parseOptions(_531), $.fn.numberbox.parseOptions(_531), {});
    };
        ...
        return this.each(function() {
            ...
            if (_54e) {
                ...
                $.data(this, "timespinner", {
                    options: $.extend({},
                    $.fn.timespinner.defaults, $.fn.timespinner.parseOptions(this), _54b)
                });
            }
            _53a(this);
        });
    ...
    $.fn.timespinner.parseOptions = function(_550) {
        return $.extend({},
        $.fn.spinner.parseOptions(_550), $.parser.parseOptions(_550, ["separator", {
            showSeconds: "boolean",
            highlight: "number"
        }]));
    };
        ...
        return this.each(function() {
            ...
            if (_559) {
                ...
                $.data(this, "datetimespinner", {
                    options: $.extend({},
                    $.fn.datetimespinner.defaults, $.fn.datetimespinner.parseOptions(this), _556)
                });
            }
            _554(this);
        });
    ...
    $.fn.datetimespinner.parseOptions = function(_55a) {
        return $.extend({},
        $.fn.timespinner.parseOptions(_55a), $.parser.parseOptions(_55a, []));
    };
    ...
    $.fn.propertygrid = function(_78a, _78b) {
        ...
        return this.each(function() {
            ...
            if (_78d) {
                ...
                var opts = $.extend({},
                $.fn.propertygrid.defaults, $.fn.propertygrid.parseOptions(this), _78a);
                opts.frozenColumns = $.extend(true, [], opts.frozenColumns);
                opts.columns = $.extend(true, [], opts.columns);
    ...
    $.fn.propertygrid.parseOptions = function(_78e) {
        return $.extend({},
        $.fn.datagrid.parseOptions(_78e), $.parser.parseOptions(_78e, [{
            showGroup: "boolean"
        }]));
    };
    var _78f = $.extend({},
    ...
    function _7d0(_7ef, _7f0, _7f1, _7f2, _7f3) {
        ...
        var _7f6 = opts.loader.call(_7ef, _7f4,
        function(data) {
    ...
    function _7d5(_7fe, _7ff) {
        ...
        function _801(_803) {
            ...
            if (_804 && _804.children) {
                for (var i = 0,
                len = _804.children.length; i < len; i++) {
    ...
    function _80e(_80f, _810) {
        ...
        if (_811.length) {
            ...
            _7d0(_80f, row[opts.idField], _813, true,
            function() {
                if (cc.is(":empty")) {
                    _811.remove();
                } else {
        ...
        return this.each(function() {
            ...
            if (_83f) {
                ...
                _83f = $.data(this, "treegrid", {
                    options: $.extend({},
                    $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _83c),
                    data: []
                });
            }
            _7b7(this);
    ...
    $.fn.treegrid.parseOptions = function(_848) {
        return $.extend({},
        $.fn.datagrid.parseOptions(_848), $.parser.parseOptions(_848, ["treeField", {
            animate: "boolean"
        }]));
    };
    var _849 = $.extend({},
    ...
    function _892(_893) {
        ...
        $(_893).addClass("combo-f").textbox($.extend({},
        opts, {
            icons: _896,
            onChange: function() {}
        }));
        ...
        return this.each(function() {
            ...
            if (_8d2) {
                ...
                _8d2 = $.data(this, "combo", {
                    options: $.extend({},
                    $.fn.combo.defaults, $.fn.combo.parseOptions(this), _8cf),
                    previousText: ""
                });
    ...
    $.fn.combo.parseOptions = function(_8d5) {
        var t = $(_8d5);
        return $.extend({},
        $.fn.textbox.parseOptions(_8d5), $.parser.parseOptions(_8d5, ["separator", "panelAlign", {
            panelWidth: "number",
    ...
    function _906(_907) {
        ...
        $(_907).combo("panel").unbind().bind("mouseover",
        function(e) {
        ...
        return this.each(function() {
            ...
            if (_90d) {
                ...
                _90d = $.data(this, "combobox", {
                    options: $.extend({},
                    $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _90a),
                    data: []
                });
                _906(this);
    ...
    $.fn.combobox.parseOptions = function(_914) {
        var t = $(_914);
        return $.extend({},
        $.fn.combo.parseOptions(_914), $.parser.parseOptions(_914, ["valueField", "textField", "groupField", "mode", "method", "url"]));
    };
    ...
    $.fn.combotree = function(_937, _938) {
        ...
        return this.each(function() {
            ...
            if (_93a) {
                ...
                $.data(this, "combotree", {
                    options: $.extend({},
                    $.fn.combotree.defaults, $.fn.combotree.parseOptions(this), _937)
                });
            }
            _926(this);
        });
    ...
    $.fn.combotree.parseOptions = function(_93e) {
        return $.extend({},
        $.fn.combo.parseOptions(_93e), $.fn.tree.parseOptions(_93e));
    };
    ...
    function _93f(_940) {
        ...
        var grid = _941.grid;
        $(_940).addClass("combogrid-f").combo($.extend({},
        opts, {
            onShowPanel: function() {
        ...
        return this.each(function() {
            ...
            if (_964) {
                ...
                _964 = $.data(this, "combogrid", {
                    options: $.extend({},
                    $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _961)
                });
            }
            _93f(this);
        });
    ...
    $.fn.combogrid.parseOptions = function(_968) {
        var t = $(_968);
        return $.extend({},
        $.fn.combo.parseOptions(_968), $.fn.datagrid.parseOptions(_968), $.parser.parseOptions(_968, ["idField", "textField", "mode"]));
    };
    ...
    function _969(_96a) {
        ...
        $(_96a).addClass("datebox-f").combo($.extend({},
        opts, {
            onShowPanel: function() {
                _96c();
    ...
    $.fn.datebox = function(_97e, _97f) {
        ...
        return this.each(function() {
            ...
            if (_981) {
                ...
                $.data(this, "datebox", {
                    options: $.extend({},
                    $.fn.datebox.defaults, $.fn.datebox.parseOptions(this), _97e)
                });
            }
            _969(this);
        });
    ...
    $.fn.datebox.parseOptions = function(_984) {
        return $.extend({},
        $.fn.combo.parseOptions(_984), $.parser.parseOptions(_984, ["sharedCalendar"]));
    };
        ...
        return this.each(function() {
            ...
            if (_99e) {
                ...
                $.data(this, "datetimebox", {
                    options: $.extend({},
                    $.fn.datetimebox.defaults, $.fn.datetimebox.parseOptions(this), _99b)
                });
            }
            _989(this);
        });
    ...
    $.fn.datetimebox.parseOptions = function(_9a1) {
        var t = $(_9a1);
        return $.extend({},
        $.fn.datebox.parseOptions(_9a1), $.parser.parseOptions(_9a1, ["timeSeparator", "spinnerWidth", {
            showSeconds: "boolean"
        }]));
    };
    ...
    function _9be(_9bf) {
        ...
        _9c1.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",
        function(e) {
        ...
        return this.each(function() {
            ...
            if (_9dc) {
                ...
                _9dc = $.data(this, "slider", {
                    options: $.extend({},
                    $.fn.slider.defaults, $.fn.slider.parseOptions(this), _9da),
                    slider: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.slider.parseOptions = function(_9df) {
        var t = $(_9df);
        return $.extend({},
        $.parser.parseOptions(_9df, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            min: "number",
            max: "number",
